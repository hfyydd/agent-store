    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50 overflow-y-auto">
      <div className="bg-white rounded-lg shadow-xl w-[480px] max-w-full my-8 mx-auto">
        <div className="flex justify-between items-center px-6 py-4 border-b border-gray-200 sticky top-0 bg-white z-10">
          <h2 className="text-xl font-semibold text-gray-800">上传 Workflow</h2>
          ...
          <form onSubmit={handleSubmit} className="px-6 py-4">
            ...
            <div className="mb-4">
              <label className="block text-sm font-medium text-gray-700 mb-1" htmlFor="name">
                Workflow 名称 <span className="text-red-500">*</span>
              </label>
              <input
                id="name"
                type="text"
                ...
                placeholder="给 workflow 起一个独一无二的名字"
                required
                maxLength={40}
              />
            ...
            <div className="mb-4">
              ...
              <textarea
                ...
                className="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                rows={3}
                placeholder="介绍 workflow 的功能， 将会展示给用户"
                maxLength={800}
              />
            ...
            <div className="mb-4">
              <label className="block text-sm font-medium text-gray-700 mb-1" htmlFor="yaml">
                YAML 文件 <span className="text-red-500">*</span>
              </label>
              <input
                id="yaml"
                type="file"
